-- EAMS Data Import for Neon.tech
  ...
  TRUNCATE transfer_logs, export_logs, employees, rooms, users, porta_cabins RESTART IDENTITY CASCADE;

  -- Insert Porta Cabins (13)
  INSERT INTO porta_cabins (id, name, location, status) VALUES (1, 'Cabin A', 'Camp A Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (2, 'Cabin B', 'Camp B Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (3, 'Cabin C', 'Camp C Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (4, 'Cabin D', 'Camp D Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (5, 'Cabin E', 'Camp E Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (6, 'Cabin F', 'Camp F Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (7, 'Cabin G', 'Camp G Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (8, 'Cabin H', 'Camp H Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (9, 'Cabin I', 'Camp I Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (10, 'Cabin J', 'Camp J Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (11, 'Cabin K', 'Camp K Zone', 'active');
INSERT INTO porta_cabins (id, name, location, status) VALUES (12, 'Cabin L', 'Camp L Zone', 'active');
...
INSERT INTO employees (id, employee_id_no, name, iqama, mobile, department, company, profile_image, status, room_id) VALUES (95, '21601', 'MR. ADEL GHAZAL SALEEM', '2579056462', '0595365160', 'WOOD', 'AL-HURAFI', NULL, 'active', NULL);
  ...
  SELECT setval('porta_cabins_id_seq', (SELECT MAX(id) FROM porta_cabins));
